  ...
  return (
    <div className="flex gap-4 overflow-hidden">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="flex flex-col items-center gap-2 flex-shrink-0 w-[104px] animate-pulse">
...
export default function ArtistHomeSection({ limit = 8 }: ArtistHomeSectionProps) {
