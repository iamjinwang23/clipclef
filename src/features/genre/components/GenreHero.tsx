...
function Thumbnail({
  ...
  if (url) {
    return (
      <div
        className="relative rounded-md overflow-hidden shadow-lg flex-shrink-0"
  ...
  return (
    <div
      className="rounded-md bg-[var(--subtle)] flex items-center justify-center font-bold text-white/80 flex-shrink-0"
